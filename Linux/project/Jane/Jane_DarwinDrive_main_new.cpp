...
//ColorFinder(hue, hue_tol, min_saturation, min_value, min_per, max_per)
	...
	case DRIVE:
	     {		
			...
			Action::GetInstance()->m_Joint.SetCCWSlope(8, 128);
			Action::GetInstance()->m_Joint.SetCCWSlope(9, 128);
			Action::GetInstance()->m_Joint.SetCCWSlope(10, 128);
			Action::GetInstance()->m_Joint.SetCCWSlope(11, 128);
			Action::GetInstance()->m_Joint.SetCCWSlope(12, 128);

			Action::GetInstance()->m_Joint.SetCWSlope(7, 128);
			Action::GetInstance()->m_Joint.SetCWSlope(8, 128);
			Action::GetInstance()->m_Joint.SetCWSlope(9, 128);
			Action::GetInstance()->m_Joint.SetCWSlope(10, 128);
			Action::GetInstance()->m_Joint.SetCWSlope(11, 128);
			Action::GetInstance()->m_Joint.SetCWSlope(12, 128);
